...
$display_list_toggle = FALSE;
	...
	switch($engine->cleanGet['MYSQL']['listType']) {
		case 'metadataObjects':
			...
			$breadCrumbs[] = '<li class="pull-right noDivider"><a href="https://github.com/wvulibraries/mfcs/wiki/Subject-Headings" target="_blank"> <i class="fa fa-book"></i> Documentation</a></li>';
			break;
		case 'selectForm':
